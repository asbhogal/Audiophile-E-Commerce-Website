...
export default function Hero() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 items-end justify-center gap-8 sm:gap-16 md:gap-0 pb-4 bg-black absolute top-0 min-h-dvh w-full left-0 overflow-hidden">
      <div className="flex flex-col gap-6 items-center md:items-start lg:max-w-[28rem] w-full md:ml-14 relative z-10 sm:static">
        <span className="overhang text-center md:text-start">New Product</span>
        <h1 className="display-font text-center md:text-start">
      ...
      <picture className="absolute w-full left-1/4 opacity-55">
